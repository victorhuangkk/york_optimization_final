...
\lstinputlisting[language=python, basicstyle=\tiny]{trust_region.py}
...
\includegraphics[width=12cm]{problem12_plt2.png}
...
\begin{section}{Problem 13}
   ...
   \includegraphics[width=10cm]{problem13.png}
    ...
    \lstinputlisting[language=python, basicstyle=\small]{cg_algo.py}
